...
public class VoidSkyIslandsBiome {
    ...
    public static Biome create(BootstrapContext<Biome> context) {
        ...
        return new Biome.BiomeBuilder()
                ...
                .specialEffects(new BiomeSpecialEffects.Builder()
                        ...
                        .ambientLoopSound(EnderscapeBiomeSounds.VOID_SKY_ISLANDS.loop())
                        .ambientAdditionsSound(new AmbientAdditionsSettings(EnderscapeBiomeSounds.VOID_SKY_ISLANDS.additions(), 0.0006))
                        .ambientMoodSound(new AmbientMoodSettings(EnderscapeBiomeSounds.VOID_SKY_ISLANDS.mood(), 6000, 8, 2))
                        .backgroundMusic(Musics.createGameMusic(EnderscapeBiomeSounds.VOID_SKY_ISLANDS.music()))
                        .build()
                )
