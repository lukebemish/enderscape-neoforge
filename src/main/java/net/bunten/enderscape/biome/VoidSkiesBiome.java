    ...
    public static Biome create(BootstrapContext<Biome> context) {
        ...
        return new Biome.BiomeBuilder()
                ...
                .specialEffects(new BiomeSpecialEffects.Builder()
                        ...
                        .ambientLoopSound(EnderscapeBiomeSounds.VOID_SKIES.loop())
                        .ambientAdditionsSound(new AmbientAdditionsSettings(EnderscapeBiomeSounds.VOID_SKIES.additions(), 0.0006))
                        .ambientMoodSound(new AmbientMoodSettings(EnderscapeBiomeSounds.VOID_SKIES.mood(), 6000, 8, 2))
                        .backgroundMusic(Musics.createGameMusic(EnderscapeBiomeSounds.VOID_SKIES.music()))
                        .build()
                )
