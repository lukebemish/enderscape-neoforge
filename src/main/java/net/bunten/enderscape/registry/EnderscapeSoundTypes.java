...
public class EnderscapeSoundTypes {
    ...
    public static final SoundType CELESTIAL_CHANTERELLE = registerSoundType("celestial_chanterelle", 1, 1.2F);
    public static final SoundType CELESTIAL_GROWTH = registerSoundType("celestial_growth", 0.5F, 1);
    public static final SoundType CELESTIAL_HANGING_SIGN = registerSoundType("celestial_hanging_sign", 0.8F, 1.2F);
    public static final SoundType CELESTIAL_OVERGROWTH = registerSoundType("celestial_overgrowth", 1, 1.1F);
    public static final SoundType CELESTIAL_PLANKS = registerSoundType("celestial_planks", 1, 1);
    public static final SoundType CELESTIAL_STEM = registerSoundType("celestial_stem", 1, 1);
    public static final SoundType CHORUS_CAKE_ROLL = registerSoundType("chorus_cake_roll", 1, 1.2F);
    public static final SoundType CHORUS_FLOWER = registerSoundType("chorus_flower", 1, 1.15F);
    public static final SoundType CHORUS_PLANT = registerSoundType("chorus_plant", 1, 1.15F);
    ...
    public static final SoundType END_PORTAL_FRAME = registerSoundType("end_portal_frame", 1, 1.2F);
    public static final SoundType END_ROD = registerSoundType("end_rod", 1, 1.3F);
    ...
    public static final SoundType MIRESTONE_SHADOLINE_ORE = registerSoundType("mirestone_shadoline_ore", 1, 1);
    ...
    public static final SoundType SHULKER_BOX = registerSoundType("shulker", 1, 1.3F);
    public static final SoundType VEILED_END_STONE = registerSoundType("veiled_end_stone", 1, 1.2F);
    ...
    public static final SoundType VEILED_LOG = registerSoundType("veiled_log", 1, 1.1F);
    ...
    protected static String block(String name, String append) {
        return "block." + name + "." + append;
    }

    protected static SoundType registerSoundType(String name, float volume, float pitch) {
        return new SoundType(volume, pitch, Enderscape.registerSoundEvent(block(name, "break")), Enderscape.registerSoundEvent(block(name, "step")), Enderscape.registerSoundEvent(block(name, "place")), Enderscape.registerSoundEvent(block(name, "hit")), Enderscape.registerSoundEvent(block(name, "fall")));
    }
}
