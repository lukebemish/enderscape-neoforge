...
public class UnripeFlangerBerryBlock extends Block implements BonemealableBlock {

    public UnripeFlangerBerryBlock(Properties settings) {
        super(settings);
    }

    public static final MapCodec<UnripeFlangerBerryBlock> CODEC = simpleCodec(UnripeFlangerBerryBlock::new);

    @Override
    public MapCodec<UnripeFlangerBerryBlock> codec() {
        return CODEC;
    }
    ...
    public void performBonemeal(ServerLevel world, RandomSource random, BlockPos pos, BlockState state) {
        BlockState ripe = EnderscapeBlocks.RIPE_FLANGER_BERRY_BLOCK.get().defaultBlockState();
